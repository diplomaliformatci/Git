...
public class Frameolustur extends JPanel
    ...
    protected static ImageIcon createNavigationIcon(String imageName) {
        String imgLocation = "toolbarButtonGraphics/navigation/"
                             + imageName
                             + ".gif";
        java.net.URL imageURL = Frameolustur.class.getResource(imgLocation);
    ...
    private static void createAndShowGUI() {
        ...
        JFrame frame = new JFrame("Frameolustur");
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
 
        //Create/set menu bar and content pane.
        Frameolustur demo = new Frameolustur();
